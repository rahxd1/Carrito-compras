...
//consulta en toda la  tabla
             ...
             $sql="SELECT * FROM pedidos where tiempo='$tiempo' order by producto";
             $res=mysql_query($sql,$con);
             $num=mysql_num_rows($res);
             echo "<table  width='90%' height='50%' >";
             echo "<tr ><th> Producto</th><th> Cantidad</th><br/><br/>";
             for($i=0;$i<$num;$i++){
               ...
               //echo "$id- $nombre <br/>";
             echo "<tr id=$id ><td> $pro</td><td> $can</td><td><a href='elicar.php?id=$id' ><img src='imagenes/cancel.jpg' width=25 height=25></a></td><tr>";
